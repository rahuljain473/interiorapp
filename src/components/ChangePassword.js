		...
		<div className="container">
			...
			<div className="login-form-grids animated wow slideInUp" data-wow-delay=".5s">
				<form>
					...
					<input type="password" placeholder="Confirm New Password" name="connewpass" onChange={(e)=>setconnewpass(e.target.value)} required=" "/>
					
					<input type="button" onClick={onpasschange} value="Login"/> <br/> <br/>
					{msg}
				</form>
			</div>
		</div>
