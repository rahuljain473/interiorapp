			...
			<div className="login-form-grids">
				<form name="form1">
                   ...
                   {editmode?<img alt="catpic" src={`uploads/${catpic}`} height="75"/>:null}<br/>
					...
					<input type="button" className="btn btn-primary" name="btn" onClick={onsubmit} value={editmode?"Update":"Add"}/>&nbsp;
                    {editmode?<input type="button" className="btn btn-primary" name="btn2" onClick={oncancel} value="Cancel"/>:null}<br/>
					{msg}
				</form>
			</div>
            <br/>
